const projectsArray = [{
	...
	implement: 'Android、Wear OSアプリケーションとして実装。スマートフォンと超小型ワイヤレスマウスをペアリングし、自端末にADBコマンドを発行することによってマウスイベントを監視。スマートフォンとペアリングされたスマートウォッチに移動量を送信してアプリケーションを操作する。',
	keywords: ['Android', 'Wear OS', 'Android Debug Bridge', 'Human Computer Interaction', 'smartwatch', 'image sensor', 'mouse']
}, {
	name: 'Ichimonitto',
	...
	implement: 'チームで制作。Processingで実装。身体にブレの度合いは動体験知によって数値化する。動体検知の実装を担当。顔の美顔化処理には、関川ら[1]のアルゴリズムを利用。',
	keywords: ['media art', 'motion detection', 'image processing'],
	links: {
		'ε-フィルタを用いたリアルタイム顔画像美観化システム': 'https://www.ieice.org/iss/jpn/Publications/issposter_2015/data/pdf/ISS-P-78.pdf',
	},
}, {
	name: 'Make if',
